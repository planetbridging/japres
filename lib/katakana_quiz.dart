...
class KatakanaQuiz extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _KatakanaQuiz();
}

class _KatakanaQuiz extends State<KatakanaQuiz> with TickerProviderStateMixin {
...
void nextQuestion(String a){
  ...
  if(itemView < importedargs.normal.length - 1){
      ...
      ObjQuizResults tmpobj = new ObjQuizResults("Katakana " + importedargs.group,results);
